...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Tsu. Osmar Feregrino ©2023");
		...
		lblCopyR.setFont(new Font("Roboto", Font.PLAIN, 8));
		...
		lblTitulo.setFont(new Font("Roboto Light", Font.BOLD, 15));
		Color customColor = new Color(1, 32, 80);
		lblTitulo.setForeground(customColor);
